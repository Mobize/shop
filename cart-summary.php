			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr id="product-<?= $product['id'] ?>">
						...
						<td class="col-sm-1 col-md-2 text-center"><strong><?= $product['price'] * $quantity ?> €</strong></td>
					...
					<tr>
						...
						<td class="text-right"><h5><strong id="cart-subtotal"><?= formatAmount($subtotal) ?></strong></h5></td>
					</tr>
					<tr>
						<td>   </td>
						<td>   </td>
						...
						<td class="text-right"><h5><strong id="cart-shipping"><?= formatAmount($shipping) ?></strong></h5></td>
					</tr>
					<tr>
						<td>   </td>
						<td>   </td>
						<td>   </td>
						<td><h3>Total</h3></td>
						<td class="text-right"><h3><strong id="cart-total"><?= formatAmount($total) ?></strong></h3></td>
					</tr>
					<tr>
						<td>   </td>
						<td>   </td>
